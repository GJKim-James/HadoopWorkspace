 ...
 */
// 3 맵리듀스 프로그래밍 기초 PPT 14페이지에 세부 설명
// FileInputFormat 객체로 분석할 파일을 읽으면, 무조건 LongWritable, Text로 설정함
// Shuffle and Sort에 값을 전달할 데이터 타입(Text, IntWritable)
// Shuffle and Sort는 리듀서에 같은 데이터 타입(Text, IntWritable)으로 전달
